# PlanetKit quick start for macOS (Group Audio Call)
...
Open Xcode project `planet-kit-quickstart-macos-group-audio-call.xcodeproj` with Xcode.
...
Once you're connected to the call, you can communicate with other participants. Click **Leave** to leave the group call.
